...
class Question
{
    ...
    #[ORM\Column]
    private ?int $nombreOfResonse = null;
    ...
    public function getNombreOfResonse(): ?int
    {
        return $this->nombreOfResonse;
    }

    public function setNombreOfResonse(int $nombreOfResonse): self
    {
        $this->nombreOfResonse = $nombreOfResonse;
